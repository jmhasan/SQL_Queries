...
select a.xzone Zone_Name,a.xriid RI_ID,(select xname from prmst where xemp=a.xriid) RI_Name,
(select xtsoid from cacushrc where xriid=a.xriid) xtsoid,a.xid,a.xoutletname,
...
group by a.xzone,a.xriid,a.xid,a.xoutletname)
select Zone_Name,xtsoid,dbo.empname(xtsoid),sum(AUG2020) "AUG2020",sum(SEP2020) SEP2020,sum(OCT2020) OCT2020,sum(NOV2020) NOV2020,sum(DEC2020) DEC2020,SUM(JAN2021) JAN2021,
