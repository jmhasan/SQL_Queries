...
SET @DynamicPivotQuery = 
 ...
 CONVERT(date,DATEADD(HOUR,-6,xconfirmt)) xymonthfrom, xqtychl from opchallandt where CONVERT(date,DATEADD(HOUR,-6,xconfirmt)) BETWEEN ''2021-05-01'' and ''2021-05-17''
