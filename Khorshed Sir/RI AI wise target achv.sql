...
SUM(xqtychl)/20 xqtychl from opchallandt where xdatecom between  '2020-11-01' and '2020-11-14' 
...
xemp not in (select xteam from opchallan where xdatecom between  '2020-11-01' and '2020-11-14' and xdiv in ('Dhaka','Out Dhaka','Corporate') ))
...
sum(xrow),sum(xqty),sum(xqtychl) from cte
