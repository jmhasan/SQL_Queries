...
where zid=100000 and xdate  between '2021-08-01' and '2021-08-04' ) AS xymonthfrom
...
where CONVERT(date,DATEADD(HOUR,-6,xconfirmt)) between ''2021-08-01'' and ''2021-08-04'' and  xstatusadvmach<>''1-Open'' ) ps
    PIVOT(SUM(xqtysms) 
