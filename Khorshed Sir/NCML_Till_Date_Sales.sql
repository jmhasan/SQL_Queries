...
where xstatusdor<>'C-Cancelled' and h.xdate<='2021-01-20' group by c.xbloodgrp having sum(d.xqty-d.xqtychl)>0

select xbloodgrp,sum(xqtychl/20) tillsales,
sum(case when xconfirmt between '2021-01-19 06:00:00' and '2021-01-20 06:00:00' then xqtychl/20 else 0 end) ondsales from 
...
where xstatuschl='3-Invoiced' and 
 xconfirmt between '2021-01-01 06:00:00' and '2021-01-20 06:00:00' --and h.xcus='CUS-000041'
group by xbloodgrp
