...
sum(case when CONVERT(date,DATEADD(HOUR,-6,xconfirmt))='2021-01-18' then xqtychl/20 else 0 end) ondsales,

sum(case when CONVERT(date,DATEADD(HOUR,-6,xconfirmt)) between '2021-01-01' and '2021-01-18' 
 then (xqtychl/20) else 0 end) tillsales,

sum(case when CONVERT(date,DATEADD(HOUR,-6,xconfirmt)) between '2020-12-01' and '2020-12-18'
then  (xqtychl/20) else 0 end) tilldatelastmonth,

sum(case when CONVERT(date,DATEADD(HOUR,-6,xconfirmt)) between '2020-01-01' and '2020-01-18' 
