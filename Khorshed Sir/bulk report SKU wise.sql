...
sum(case when CONVERT(date,DATEADD(HOUR,-6,xconfirmt))='2021-05-18' then xqtychl/20 else 0 end) ondsales,
...
sum(case when CONVERT(date,DATEADD(HOUR,-6,xconfirmt)) between '2021-04-01' and '2021-04-18'
then  (xqtychl/20) else 0 end) tilldatelastmonth,

sum(case when CONVERT(date,DATEADD(HOUR,-6,xconfirmt)) between '2020-05-01' and '2020-05-18' 
