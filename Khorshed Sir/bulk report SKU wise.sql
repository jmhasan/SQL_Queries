...
sum(case when CONVERT(date,DATEADD(HOUR,-6,xconfirmt))='2021-07-14' then xqtychl/20 else 0 end) ondsales,
...
sum(case when CONVERT(date,DATEADD(HOUR,-6,xconfirmt)) between '2021-06-01' and '2021-06-14'
then  (xqtychl/20) else 0 end) tilldatelastmonth,

sum(case when CONVERT(date,DATEADD(HOUR,-6,xconfirmt)) between '2020-07-01' and '2020-07-14' 
