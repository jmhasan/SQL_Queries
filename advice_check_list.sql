...
select xadvnum,xqtysms,xqty,xqtychl,xqtycut,xchallantime,xstatusadvmach from opadvice where xadvnum='PCMLDOA-0120-014837' 

select xmachnum,xchlnum,xconfirmt from opchallan where xadvnum='PCMLDOA-0120-014837'
select xmachnum,xchallantime from opmachadviced where xadvnum='PCMLDOA-0120-014837'
