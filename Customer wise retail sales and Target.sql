...
Realistic_com,Retail_com,Lifting_com, Cas_dis, Free_bag,
 Cas_party, Promotional_offer, Yearly_com,sum(Nov2020),sum(Criteria_1) Criteria_1,sum(Criteria_2) Criteria_2,sum(Criteria_3) Criteria_3,count(*) no_of_retail from xyx
group by xzone,xcus,xorg,xgcus,General_Com,
Realistic_com,Retail_com,Lifting_com, Cas_dis, Free_bag,
